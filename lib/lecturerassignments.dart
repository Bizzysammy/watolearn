...
import 'package:wato/Assignments/download.dart';
import 'package:wato/notification/notifcation_s.dart';
import 'package:wato/profile/lecturerprofile.dart';
import 'package:wato/Assignments/results.dart';
import 'package:wato/Assignments/upload.dart';


class Lecturerassignments extends StatefulWidget {
  const Lecturerassignments({Key? key}) : super(key: key);

  @override
  LecturerassignmentsState createState() => LecturerassignmentsState();
}

class LecturerassignmentsState extends State<Lecturerassignments> {
  @override
