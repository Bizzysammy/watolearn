...
import 'package:wato/lecturer_home/Exploreme.dart';
import 'package:wato/lecturer_register/register.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: const Text('Sign Up As A Lecturer'),
                    ),
                  ],
                ),
              ),
  ...
  Future<void> login(
    ...
    try {
      ...
      if (querySnapshot.docs.isEmpty) {
        ...
        _showErrorSnackBar(context, 'User not found only lectures can login here');
        return;
      }
      // Sign in the user with Firebase Authentication
      UserCredential lecturerCredential =
      ...
      // Get the lecturer document data
      Map<String, dynamic> lecturerData =
      querySnapshot.docs.first.data() as Map<String, dynamic>;
      String course = lecturerData['course'];

      // Update the loginTimes subcollection in the user document
      await userDocRef.collection('loginTimes').add({
        'timestamp': timestamp,
        'course': course,
      });
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const Exploreme()),
      );
